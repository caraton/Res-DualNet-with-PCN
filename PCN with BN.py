...
if __name__ == "__main__":
    ...
    # model = testpcnet(learning_rate, device)
    # model = pcnet(learning_rate, device)
    model = pcnet_10(learning_rate, device)
